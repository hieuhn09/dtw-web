...
- The brand evolution (pre-rebrand, tới 2026-09: Dailytechwire wordmark + reintroduced navy DTW monogram logo 2026-06-14, "Tech Intelligence, Wired Daily" sentence-case tagline; renamed to Opentechwire/OTW monogram + "Tech Intelligence, Openly Wired" tagline by rebrand decision 2026-09-08, ledger D1/D2/D8 — see `process/features/rebrand/active/rebrand-opentechwire-umbrella_PLAN_08-09-26.md`; asset files redrawn 2026-09-09 by Phase 3 — icons generated via `apps/web/scripts/generate-brand-icons.mjs`)
...
| Wordmark + logo | Navy `OTW` monogram + lowercase "opentechwire" + terracotta pulse-dot (shipped 2026-09-09 by Phase 3 of the rebrand plan; regenerate the raster icons via `apps/web/scripts/generate-brand-icons.mjs`) | Logo badge **reintroduced** in the 2026-06-14 refresh (the `design/` bundle keeps `dtw-logo-primary.svg` frozen as a historical record; the live asset is `apps/web/public/otw-logo-primary.svg`), superseding the earlier wordmark-only rule. Monogram `--brand-navy` (dark `#E2E8F0`), dot `--brand-amber #D4623C` — colors unchanged by the rebrand (D10). |
