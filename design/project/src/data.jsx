...
const ARTICLES = [
  ...
  },
  {
    ...
    pillar:"startups", section:"Deals",
    title:"One year on, the Tokopedia–Grab merger is finally producing the layoffs nobody promised",
  ...
  {
    id:"a5", slug:"taiwan-chip-export-rules",
    pillar:"policy", section:"Trade",
  ...
  {
    id:"a6", slug:"react-server-actions-tradeoffs",
  ...
  },
  {
    ...
    readMin:6,
    sponsored:true, sponsor:"AWS ASEAN",
  },
  {
  ...
  // === Additional fill, ensures every pillar has ≥4 ===
  {
    id:"a13", slug:"alibaba-cloud-inference-tier",
    pillar:"ai", section:"Infra",
    ...
    author:"rkim",
    published:"2026-05-21T09:30:00+08:00", readMin:6,
  },
  {
  ...
  },
  {
    ...
    author:"mlin",
    published:"2026-05-20T08:00:00+08:00", readMin:11,
  },
  {
  ...
  {
    id:"a20", slug:"samsung-galaxy-s26-review",
    pillar:"products", section:"Review",
    ...
    author:"jchen",
    published:"2026-05-19T15:00:00+09:00", readMin:11,
    affiliate:true,
  },
  {
    id:"a21", slug:"meta-quest-pro-2-review",
    pillar:"products", section:"Review",
    ...
    author:"jchen",
    published:"2026-05-18T16:00:00+08:00", readMin:9,
    affiliate:true,
  },
  {
    id:"a22", slug:"asus-rog-flow-z14",
    pillar:"products", section:"Review",
    ...
    author:"jchen",
    published:"2026-05-17T12:00:00+08:00", readMin:8,
    affiliate:true,
  },
  {
...
const WIRE_DROPS = [
  ...
  { id:"w5", time:"07:31", city:"Taipei",    text:"TSMC reshuffles advanced-packaging allocation; three named customers, two unnamed." },
  { id:"w6", time:"07:06", city:"Bengaluru", text:"RBI clears UPI bilateral go-live with Vietnam; SBV joint statement at 09:00 local." },
  { id:"w7", time:"06:48", city:"Tokyo",     text:"Sony confirms PS6 dev kits in partner studios; no consumer timeline." },
  { id:"w8", time:"06:22", city:"Manila",    text:"GCash parent files for separate listing; ride-hailing arm stays private." },
];
...
// expose globally
Object.assign(window, { PILLARS, NAV_EXTRA, AUTHORS, ARTICLES, WIRE_DROPS, FUNDING_ROWS, AI_LEADERBOARD, NEWSLETTERS, PODCASTS });
