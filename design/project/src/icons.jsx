...
function Icon({ name, size = 18, color = "currentColor", stroke = 1.75, ...rest }) {
  const s = size;
  const c = color;
  const w = stroke;
  const common = {
  ...
  switch (name) {
    ...
    case "play":     return <svg {...common} fill={c} stroke="none"><polygon points="6 4 20 12 6 20 6 4"/></svg>;
    case "pause":    return <svg {...common} fill={c} stroke="none"><rect x="6" y="4" width="4" height="16"/><rect x="14" y="4" width="4" height="16"/></svg>;
    ...
    case "rss":      return <svg {...common}><path d="M4 11a9 9 0 0 1 9 9"/><path d="M4 4a16 16 0 0 1 16 16"/><circle cx="5" cy="19" r="1.5" fill={c}/></svg>;
    case "globe":    return <svg {...common}><circle cx="12" cy="12" r="9"/><line x1="3" y1="12" x2="21" y2="12"/><path d="M12 3a13 13 0 0 1 0 18M12 3a13 13 0 0 0 0 18"/></svg>;
    ...
    case "trend-up": return <svg {...common}><polyline points="3 17 9 11 13 15 21 7"/><polyline points="14 7 21 7 21 14"/></svg>;
    ...
    case "feather":  return <svg {...common}><path d="M21 8a4 4 0 0 0-4-4H9L3 17v4h4l14-14z"/><line x1="16" y1="8" x2="2" y2="22"/><line x1="17" y1="13" x2="9" y2="13"/></svg>;
    ...
    case "data":     return <svg {...common}><rect x="3" y="3" width="18" height="18" rx="2"/><line x1="9" y1="3" x2="9" y2="21"/><line x1="15" y1="3" x2="15" y2="21"/><line x1="3" y1="9" x2="21" y2="9"/></svg>;
    case "code":     return <svg {...common}><polyline points="16 18 22 12 16 6"/><polyline points="8 6 2 12 8 18"/></svg>;
    case "asia":     return <svg {...common}><circle cx="12" cy="12" r="9"/><path d="M3 12a18 18 0 0 1 9-3 18 18 0 0 1 9 3"/><path d="M3 12a18 18 0 0 0 9 3 18 18 0 0 0 9-3"/></svg>;
    case "policy":   return <svg {...common}><path d="M12 22s8-4 8-12V5l-8-3-8 3v5c0 8 8 12 8 12z"/></svg>;
    case "product":  return <svg {...common}><path d="M21 16V8a2 2 0 0 0-1-1.73l-7-4a2 2 0 0 0-2 0l-7 4A2 2 0 0 0 3 8v8a2 2 0 0 0 1 1.73l7 4a2 2 0 0 0 2 0l7-4A2 2 0 0 0 21 16z"/><polyline points="3.27 6.96 12 12.01 20.73 6.96"/><line x1="12" y1="22.08" x2="12" y2="12"/></svg>;
    case "wire":     return <svg {...common}><circle cx="12" cy="12" r="2" fill={c}/><circle cx="12" cy="12" r="6"/><circle cx="12" cy="12" r="10"/></svg>;
...
Object.assign(window, { Icon, PILLAR_ICONS });
