// ============ LEGAL PAGES ============
function LegalPage({ navigate, slug }){
  const t = useT();

  const P = (en, vi, id) => t(en, vi, id);

  const pages = {
    privacy: {
      title: P("Privacy Policy", "Chính sách quyền riêng tư", "Kebijakan Privasi"),
      kicker: P("Last updated · 1 June 2026", "Cập nhật lần cuối · 01/06/2026", "Diperbarui · 1 Juni 2026"),
      intro: P(
      ...
      body: [
        [P("What we collect", "Những gì chúng tôi thu thập", "Apa yang kami kumpulkan"),
         P("An email address when you create an account or subscribe to a newsletter. Basic reading activity, which stories you open, so we can sync your saves across devices and recommend better. Standard server logs (IP, browser) kept for 30 days for security. That is the whole list.",
        ...
        [P("What we never do", "Những gì chúng tôi không bao giờ làm", "Yang tak pernah kami lakukan"),
         P("We do not sell your data. We do not share your reading history with advertisers, data brokers, or platforms. We do not run third-party ad networks or tracking pixels. We do not build shadow profiles of people who are not logged in.",
        ...
        [P("How we use it", "Cách chúng tôi sử dụng", "Cara kami memakainya"),
         P("To keep you signed in, deliver the newsletters you asked for, recommend stories on your followed beats, and understand, in aggregate, which journalism resonates. Analytics are first-party and self-hosted; no usage data leaves our infrastructure.",
        ...
        [P("Your rights", "Quyền của bạn", "Hak Anda"),
         P("You can export everything we hold on you, correct it, or delete your account outright, from your account settings, with no email required and no retention tricks. Deletion is permanent and processed within 30 days.",
        ...
        [P("Where your data lives", "Dữ liệu của bạn được lưu ở đâu", "Di mana data Anda berada"),
         P("On servers in Singapore, operated under our control. When the law of your country gives you stronger protections than ours, we apply the stronger standard. Questions about a specific jurisdiction go to info@dailytechwire.com.",
    ...
    terms: {
      title: P("Terms of Service", "Điều khoản dịch vụ", "Ketentuan Layanan"),
      kicker: P("Last updated · 1 June 2026", "Cập nhật lần cuối · 01/06/2026", "Diperbarui · 1 Juni 2026"),
      intro: P(
      ...
      body: [
        [P("Using the site", "Sử dụng trang", "Menggunakan situs"),
         P("You may read, share links to, and quote our journalism with attribution. You may not republish full articles, scrape the site at scale, or train commercial models on our content without a written licence. Reasonable personal use is always fine.",
        ...
        [P("Your account", "Tài khoản của bạn", "Akun Anda"),
         P("You are responsible for activity under your account and for keeping your sign-in secure. Tell us promptly if you suspect unauthorised access. Accounts are for individuals; team and institutional access is available separately.",
        ...
        [P("Our content", "Nội dung của chúng tôi", "Konten kami"),
         P("The journalism, data visualisations, and design on Dailytechwire are owned by Asia Press Centre Group (APCG) or used under licence. Trademarks and the masthead remain ours. We license selected content for syndication, write to partnership@dailytechwire.com.",
        ...
        [P("Accuracy & corrections", "Độ chính xác & đính chính", "Akurasi & koreksi"),
         P("We work hard to be accurate and we correct mistakes openly. The site is provided in good faith but without warranty that it is error-free or always available. Nothing we publish is investment, legal, or professional advice.",
        ...
        [P("Changes & contact", "Thay đổi & liên hệ", "Perubahan & kontak"),
         P("If we change these terms materially, we will say so on this page and, for account holders, by email. Continued use after a change means acceptance. Governing law is Singapore. Questions: info@dailytechwire.com.",
    ...
    cookies: {
      title: P("Cookie Policy", "Chính sách cookie", "Kebijakan Cookie"),
      kicker: P("Last updated · 1 June 2026", "Cập nhật lần cuối · 01/06/2026", "Diperbarui · 1 Juni 2026"),
      intro: P(
      ...
      body: [
        [P("Essential cookies", "Cookie thiết yếu", "Cookie esensial"),
         P("These keep you signed in, remember your language and light/dark preference, and protect against fraud. The site cannot work without them, so they are always on. They contain no advertising identifiers.",
        ...
        [P("Analytics cookies", "Cookie phân tích", "Cookie analitik"),
         P("A single first-party cookie helps us count reads and see which stories land, in aggregate. It is self-hosted, never shared, and you can decline it from the cookie bar without losing any features.",
        ...
        [P("What we don't set", "Những gì chúng tôi không đặt", "Yang tak kami pasang"),
         P("No advertising cookies. No third-party trackers. No cross-site pixels from social networks. If you ever find a cookie on Dailytechwire that does not fit the two categories above, tell us, it is a bug, not a policy.",
        ...
        [P("Managing cookies", "Quản lý cookie", "Mengelola cookie"),
         P("You can accept or decline analytics from the bar at the bottom of the screen, change your mind any time in account settings, or clear everything from your browser. Declining never paywalls a feature.",
    ...
    gdpr: {
      title: P("GDPR & PDPA", "GDPR & PDPA", "GDPR & PDPA"),
      kicker: P("Data protection · your rights", "Bảo vệ dữ liệu · quyền của bạn", "Perlindungan data · hak Anda"),
      intro: P(
      ...
      body: [
        [P("The rights you hold", "Các quyền bạn có", "Hak yang Anda miliki"),
         P("Access a copy of your data, correct it, delete it, restrict or object to how it is used, and take it elsewhere in a portable format. You can exercise every one of these from your account settings, or by writing to us.",
        ...
        [P("Making a request", "Gửi yêu cầu", "Mengajukan permintaan"),
         P("Email info@dailytechwire.com or use the export and deletion tools in your account. We respond within 30 days, usually far sooner, and we never charge for a reasonable request. We will verify your identity first, to protect you.",
        ...
        [P("Complaints", "Khiếu nại", "Keluhan"),
         P("If you believe we have mishandled your data, tell us first and we will try to put it right. You also have the right to complain to your local supervisory authority, the relevant DPA in the EU, or the PDPC in Singapore.",
        ...
        [P("Our Data Protection Officer", "Cán bộ bảo vệ dữ liệu", "Petugas Perlindungan Data"),
         P("A named DPO oversees how we handle personal data and is your direct line for anything on this page. Reach them at info@dailytechwire.com.",
  ...
  const navItems = [
    ["privacy", P("Privacy", "Quyền riêng tư", "Privasi")],
    ["terms",   P("Terms", "Điều khoản", "Ketentuan")],
    ["cookies", P("Cookies", "Cookie", "Cookie")],
    ["gdpr",    P("GDPR / PDPA", "GDPR / PDPA", "GDPR / PDPA")],
  ];
      ...
      <div style={{display:"grid", gridTemplateColumns:"220px 1fr", gap:48}}>
        <nav style={{position:"sticky", top:160, alignSelf:"flex-start"}}>
          <div className="upper text-mute" style={{fontSize:10, fontWeight:600, letterSpacing:".14em", marginBottom:12}}>
            {P("Legal", "Pháp lý", "Legal")}
          </div>
          {navItems.map(([k, label])=>(
            <button key={k} onClick={()=>navigate(`/legal/${k}`)} style={{
          ...
          <div style={{marginTop:24, padding:14, background:"var(--surface)", border:"1px solid var(--hair)", borderRadius:6}}>
            <div className="text-mute" style={{fontSize:12, lineHeight:1.5}}>
              {P("Questions about your data?", "Câu hỏi về dữ liệu của bạn?", "Pertanyaan soal data Anda?")}
            </div>
            <a className="linkish mono" style={{fontSize:12, color:"var(--accent)", cursor:"pointer", display:"inline-block", marginTop:6}}>info@dailytechwire.com</a>
          </div>
        </nav>

        <article style={{maxWidth:720}}>
          <div className="kicker" style={{marginBottom:8}}>{page.kicker}</div>
          <h1 className="serif" style={{margin:"0 0 20px", fontSize:48, fontWeight:650, letterSpacing:"-0.025em", lineHeight:1.05}}>
            {page.title}
          </h1>
          <p className="serif" style={{margin:"0 0 36px", fontSize:19, lineHeight:1.6, color:"var(--ink-2)"}}>
            {page.intro}
          </p>
          <div style={{fontFamily:"var(--font-serif)"}}>
            {page.body.map(([h, txt])=>(
              <section key={h} style={{marginBottom:32}}>
                ...
                <p style={{margin:0, fontSize:17, lineHeight:1.65, color:"var(--ink-2)"}}>{txt}</p>
              </section>
            ))}
          </div>
          <div style={{marginTop:24, paddingTop:20, borderTop:"1px solid var(--hair)"}} className="text-mute mono">
            <span style={{fontSize:11}}>
              {P("Asia Press Centre Group (APCG) · Singapore", "Asia Press Centre Group (APCG) · Singapore", "Asia Press Centre Group (APCG) · Singapura")}
            </span>
          </div>
        </article>
      </div>
