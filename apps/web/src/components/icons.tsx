...
export function Icon({
  ...
  // Brand marks are solid glyphs traced from each platform's official logo, so
  // they ignore the stroke geometry the rest of the set is drawn with. They also
  // fill their 24x24 box edge to edge, while the stroke icons sit inside ~2 units
  // of padding — so the viewBox is widened to 28 to give the logos the same
  // optical weight when a brand and a stroke icon sit side by side at one `size`.
  const brandCommon: SVGProps<SVGSVGElement> = {
    ...common,
    viewBox: "-2 -2 28 28",
    fill: color,
    stroke: "none",
