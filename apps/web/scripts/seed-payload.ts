...
const NEWSLETTERS: ReadonlyArray<{
  ...
  { slug: "am", name: "AM Brief", cadence: "Daily · morning SGT", description: "What broke overnight in tech, in 5 minutes.", verticalSlug: "latest", order: 1 },
  { slug: "pm", name: "PM Brief", cadence: "Daily · evening SGT", description: "The day in three stories, plus what to read tonight.", verticalSlug: "latest", order: 2 },
